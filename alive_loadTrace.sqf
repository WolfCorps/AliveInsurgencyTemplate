...
sleep 30;
private _loaded = ["alive_x_lib_TRACEGRID_STORE"] call ALiVE_fnc_getData;
if (isNil "_loaded") exitWith {diag_log ["Alive loadTrace Failed"];};
diag_log ["loadTrace",_loaded];

alive_x_lib_TRACEGRID_STORE=_loaded;
...
//ALiVE_TraceGrid_%1%2
	...
	diag_log ["Alive greenGrid Trace",_gridPos,_x];
} forEach _cleared;
